...
import {
  Image, View, StyleSheet, Text, TouchableOpacity, TouchableHighlight,
} from 'react-native';
...
export default class Home extends React.Component {
  _openPage(cmpt) {
    if (cmpt) {
      this.props.navigator.push(cmpt);
    } else {
      alert('正在开发中。。。');
    }
  }
  ...
  render() {
    const FUNCS = [
      ...
      {category: '工作', uri: BUIcon[1], subcate1: '加班', subcate2: '任务', subcate3: '事项', subcate4: '活动', bgColor: styles.sbu_blue},
              ...
              >
                <View style={[styles.sbu_flex, styles.sbu_borderRight]}>
                  ...
                  <View style={[styles.sub_con_flex]}>
                    <Image style={[styles.sbu_icon_img]} source={{ uri: category.uri }} />
                  </View>
                </View>
              </TouchableOpacity>
              <View style={[styles.sbu_flex, styles.sbu_borderRight]}>
